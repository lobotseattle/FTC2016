...
//@Autonomous(name="DCMotor 2Wheel Drive Encoder2 Backup", group="Linear Opmode")  // @Autonomous(...) is the other common choice
public class DCMotor_2Wheel_Encoder2_Backup extends LinearOpMode {
