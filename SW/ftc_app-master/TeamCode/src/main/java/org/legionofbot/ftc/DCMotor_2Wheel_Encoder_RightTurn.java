...
//@Autonomous(name="DCMotor 2Wheel Drive Encoder Right Turn", group="Linear Opmode")  // @Autonomous(...) is the other common choice
public class DCMotor_2Wheel_Encoder_RightTurn extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        rightMotor = hardwareMap.dcMotor.get("right_drive");
          ...
          double encoderCountsPerRotation = 2880; //360*4
